...
var ReactIntlUniversal = function () {
  ...
  createClass(ReactIntlUniversal, [{
    ...
    value: function get$$1(key, variables) {
      ...
      if (msg == null) {
        this.printWarning("react-intl-universal key \"" + key + "\" not defined in " + currentLocale);
        return "";
      }
      if (variables) {
      ...
      try {
        ...
        this.printWarning("react-intl-universal format message failed for key='" + key + "'", err);
        return "";
      }
    }
    ...
    */
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (isBrowser) {
          if (langUrl) {
            ...
            _this.printWarning('lang is not supported', lang);
            resolve();
          }
        } else {
    ...
    key: "printWarning",
    value: function printWarning(msg) {
